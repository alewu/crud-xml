...
//	 */
//	@Override
//	public boolean postProcessAfterInstantiation(final Object entity, String beanName) throws BeansException {
...
//						throw new NullPointerException(entity.getClass().getSimpleName() + "." + field.getName()
//								+ "is required,but not been configured");
//					} else if (value != null) {
//						Object _value = typeConverter.convertIfNecessary(value, field.getType());
//						ReflectionUtils.makeAccessible(field);
//						field.set(entity, _value);
//					}
//				}
//			}
//		});
