...
public class Encryption {
	...
	public static boolean authenticate(String attemptedPassword,
		...
		// 用相同的盐值对用户输入的密码进行加密
		String encryptedAttemptedPassword = getEncrypted(attemptedPassword,
				salt);
	 ...
	 * @throws InvalidKeySpecException
	 */
	public static String getEncrypted(String password, String salt)
			throws NoSuchAlgorithmException, InvalidKeySpecException {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException,
		...
		System.out.println(getEncrypted("admin", salt));
	}
}
