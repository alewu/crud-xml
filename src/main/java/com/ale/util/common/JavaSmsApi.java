...
public class JavaSmsApi {
    ...
    private static  String APIKEY = "990af323fe2d4bd729a054bdc9cf44e3";

    public static void main(String[] args) throws IOException, URISyntaxException {

        //修改为您的apikey.apikey可在官网（http://www.yunpian.com)登录后获取
       // String apikey = "b0e0ea4bcdc83d4e57e3552ba69e178a";
        String apikey = "990af323fe2d4bd729a054bdc9cf44e3";
        //修改为您要发送的手机号
        String mobile = "13213123552";
        ...
        String text = "【心思联创】您的验证码是" + code ;

        singleSend(apikey, text, mobile);
        //发短信调用示例
...
//        //设置对应的模板变量值
//
//        String tpl_value = URLEncoder.encode("#renterName#",ENCODING) +"="
//                + URLEncoder.encode("林羽兵", ENCODING);
//        //模板发送的调用示例
